...
export function wanI2vPreset() {
  // 官方 Wan2.1 图生视频图（Fun/官方 i2v 1.3B）——以 WanImageToImage/LoadImage 生成首帧 latent 后接 KSampler
  return {provider:'comfy',baseUrl:'http://127.0.0.1:8188',model:'Wan2.1-I2V-1.3B',keyEnv:'',profile:'Wan 2.1 · 1.3B 图生视频（首帧）',outputNode:'13',durationMode:'wan',
    params:{negative:'blurry, distorted, static, watermark, subtitles',seed:42,steps:20,cfg:6,width:832,height:480,frames:81,image:'输入示例图片.png'},
    bindings:{negative:{node:'5',input:'text'},prompt:{node:'4',input:'text'},seed:{node:'8',input:'seed'},steps:{node:'8',input:'steps'},cfg:{node:'8',input:'cfg'},width:{node:'7',input:'width'},height:{node:'7',input:'height'},frames:{node:'7',input:'length'},image:{node:'12',input:'image'}},
    workflow:{
      '1':{class_type:'UNETLoader',inputs:{unet_name:'wan2.1_i2v_480p_1.3B_fp16.safetensors',weight_dtype:'default'}},
      '2':{class_type:'CLIPLoader',inputs:{clip_name:'umt5_xxl_fp8_e4m3fn_scaled.safetensors',type:'wan',device:'default'}},
      '3':{class_type:'VAELoader',inputs:{vae_name:'wan_2.1_vae.safetensors'}},
      '4':{class_type:'CLIPTextEncode',inputs:{text:'',clip:['2',0]}},
      '5':{class_type:'CLIPTextEncode',inputs:{text:'blurry, distorted, static, watermark, subtitles',clip:['2',0]}},
      '6':{class_type:'ModelSamplingSD3',inputs:{model:['1',0],shift:8}},
      '7':{class_type:'EmptyHunyuanLatentVideo',inputs:{width:832,height:480,length:81,batch_size:1}},
      '8':{class_type:'KSampler',inputs:{model:['6',0],positive:['4',0],negative:['5',0],latent_image:['9',0],seed:42,steps:20,cfg:6,sampler_name:'uni_pc',scheduler:'simple',denoise:1}},
      '9':{class_type:'WanImageToVideo',inputs:{positive:['4',0],negative:['5',0],vae:['3',0],width:832,height:480,length:81,batch_size:1,start_image:['12',0],clip_vision_output:['11',0]}},
      '10':{class_type:'CLIPVisionLoader',inputs:{clip_name:'clip_vision_h.safetensors'}},
      '11':{class_type:'CLIPVisionEncode',inputs:{clip_vision:['10',0],image:['12',0],crop:'center'}},
      '12':{class_type:'LoadImage',inputs:{image:'输入示例图片.png'}},
      '13':{class_type:'VAEDecode',inputs:{samples:['8',0],vae:['3',0]}},
      '14':{class_type:'CreateVideo',inputs:{images:['13',0],fps:16}},
      '15':{class_type:'SaveVideo',inputs:{video:['14',0],filename_prefix:'video/CyanCreator_WanI2V',format:'mp4',codec:'auto'}}
    }
  };
}
export const videoPresets = [{id:'minimax-h3',name:'MiniMax H3 · 原生音画',create:h3Preset},{id:'wan21',name:'Wan 2.1 · 1.3B 文生视频',create:wanPreset},{id:'wan21-i2v',name:'Wan 2.1 · 1.3B 图生视频（首帧）',create:wanI2vPreset}];
