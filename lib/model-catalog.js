...
export const modelCatalog = [
  {id:'native-runtime',name:'独立视频运行时',kind:'runtime',runtime:'native',quantization:'Python / PyTorch / Diffusers',description:'仅安装独立环境，不下载视频权重。需要 Python 3.12，NVIDIA CUDA 或 CPU 诊断。',source:'https://huggingface.co/docs/diffusers/api/pipelines/wan',assets:[]},
  nativeWan,
