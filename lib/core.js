...
export function messages(stage, project) {
  ...
  return [
    ...
    {role: 'user', content: JSON.stringify(compactContext({brief: project.brief, bible: project.bible, characters:project.characters, worldbook:project.worldbook, outline: stage !== 'outline' ? project.outline : undefined, script: stage === 'review' ? project.script : undefined}))}
  ];
}
