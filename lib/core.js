...
export function messages(stage, project) {
  ...
  return [
    ...
    {role: 'user', content: JSON.stringify({brief: project.brief, bible: project.bible, outline: stage !== 'outline' ? project.outline : undefined, script: stage === 'review' ? project.script : undefined})}
  ];
}
...
export function validateSettings(s) {
  ...
  requireValue(['comfy', 'minimax', 'native'].includes(s.video.provider), '不支持的视频服务');
